...
status_code = 201
number = 0
uri_list = [str(uuid4()) for _ in range(10000)]
print(len(uri_list))
start_post_time = time.time()

while status_code == 201 and number < 10000:
    ...
    payload = json.dumps({
      ...
      "request": {
        ...
        "marks": {
          "1": {
            "mark": generate_base64_km(gtn, crypto_tail44)
          },
          "2": {
            "mark": generate_base64_km(gtn, crypto_tail44)
          }
...
while status_code == 200 and number < 10000:
    documentID = uri_list[number]
    number += 1
